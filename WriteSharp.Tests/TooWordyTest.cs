...
public class TooWordyTest
{
    ...
    private const string BadWordInSentence = "An abundance of highlights accede to long, complex sentences and common errors.";
    private const string BadPhrasesInSentence = "a number of sentences are so dense and complicated that your readers will be adversely impacted";
    ...
    private const string SentenceWithHyphen = "A transfer visa may be required at check-in between any connecting flight.";
